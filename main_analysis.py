...
def main():
    ...
    n_per_group = 87000  # размер выборки определён с помощью онлайн калькулятора с уровнем значимости 0,05, статистической мощностью 0,8, минимальным эффектом 0,1 и текущим уровнем 0,018 (среднее по нашей проблемной подвыборке)
